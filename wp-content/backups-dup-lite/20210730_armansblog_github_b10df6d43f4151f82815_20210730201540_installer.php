...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210730_armansblog_github_b10df6d43f4151f82815_20210730201540_archive.zip';
	const ARCHIVE_SIZE		 = '64571856';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b10df6d-30201540';
    const SECONDARY_PACKAGE_HASH = '6377e45-30201540';
	const VERSION			 = '1.4.2';
